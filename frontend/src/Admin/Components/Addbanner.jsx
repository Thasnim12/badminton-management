...
import { DialogContent, Dialog, TextField, DialogTitle, Grid, Button, Box, DialogActions, Typography } from "@mui/material";
...
const AddBanner = ({ open, handleClose }) => {
    ...
    const handleFileChange = (event) => {
        ...
        setFormData((prevFormData) => ({
            ...
            order: [...prevFormData.order, ...files.map((_, i) => prevFormData.order.length + i + 1)], // Auto-fill order
        }));
    };
